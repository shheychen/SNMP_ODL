...
SNMP_START_CMD = '/usr/sbin/snmpd -Lsd -Lf /dev/null -u snmp -g snmp -I -smux,mteTrigger,mteTriggerConf -p /var/run/snmpd.pid -c /etc/snmp/snmpd.conf'
SNMP_WALK_CMD = 'snmpwalk -v1 -c public '
...
def simulateNetwork():
    ...
    walkOut = h2.cmd('head -n -10 '+SNMP_WALK_OUT)
    info('\n'+walkOut+'\n')
    CLI(net)
    #net.stop()
